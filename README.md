...
This release makes Motion output identity collision-resistant, keeps queued Motion visible in its gallery, and brings video review into the Logbook and media lightbox. It also unifies media actions and language, improves keyboard and focus behavior, and streams byte-range video responses without reading complete MP4 files into memory.
